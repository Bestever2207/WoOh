...
public class UI {
    ...
    public static JComponent[] koords_screen()
    {
        ...
        JLabel strasse_tx = new JLabel("Straﬂe");
    ...
    public static void koords_screen_falsch(JComponent[] userDaten_falsch)
    {
        ...
        JLabel label_falsch = new JLabel("Achte darauf dass die Adresse eindeutig und jedes Feld ausgef¸llt ist!",SwingConstants.CENTER);
    ...
    public static JComponent[] restaurants_ausgeben(Restaurant[] suchergebnisse, double[] lieferzeiten)
    {
        ...
        for(int i = 0;i < suchergebnisse.length;i++)
        {
            ...
            JLabel preis = new JLabel("" + ((double)Math.round(suchergebnisse[i].getPreisspanne() * 100)) / 100 + "Ä");
    ...
    public static JComponent[] gerichte_ausgeben(Datenelement[][][] suchergebnisse, double[] lieferzeiten, boolean activ_btn)
    {
        ...
        for (Datenelement[][] datenelements : suchergebnisse) {
            for (int s = 0; s < datenelements[0].length; s++) {
                ...
                JLabel preis = new JLabel("" + datenelements[0][s].preis_geben() + "Ä");
    ...
    public static JComponent[] warenkorb_screen(Bestellung warenkorb)
    {
        ...
        JLabel zwischensumme_zahl = new JLabel(((double)Math.round(warenkorb.getPreis() * 100)) / 100 + "Ä");
        ...
        JLabel lieferkosten_zahl = new JLabel("0.0Ä");
        ...
        JLabel total_zahl = new JLabel(((double)Math.round(warenkorb.getPreis() * 100)) / 100 + "Ä");
        ...
        if(warenkorb.getGerichte_anzahl() != 0)
        {
            ...
            for(int i = 0;i < gerichte.length;i++) {
                ...
                JLabel preis = new JLabel("" + gerichte[i].preis_geben() + "Ä");
    ...
    public static JComponent[] bestellhistorie_screen(Bestellung[] bestellhistorie)
    {
        ...
        else
        {
            ...
            for(int i = 0;i < bestellhistorie.length;i++)
            {
                ...
                JLabel preis = new JLabel("" + bestellhistorie[i].getPreis() + "Ä");
    ...
    public static JComponent[] guthaben_screen(double akt_kontostand)
    {
        ...
        JLabel geldstand = new JLabel(akt_kontostand + "Ä");
